...
mod tests {
    ...
    fn wc_map_test() {
        ...
        assert_eq!(
            vec![KeyValue { key: "This", value: "1" }, KeyValue { key: "is", value: "1" }, KeyValue { key: "a", value: "1" }, KeyValue { key: "test", value: "1" }], 
            map_output
        );
    }
